...
| [sendrawtransaction](https://github.com/BhpAlpha/docs/blob/master/cli/1.2.0.8/api/sendrawtransaction.md) | < hex >                                             | 广播交易                                             |                  |
...
| [sendfrom](https://github.com/BhpAlpha/docs/blob/master/cli/1.2.0.8/api/sendfrom.md) | < asset_id > < from >< to > < value > [fee=0]       | 从指定地址，向指定地址转账                           | 需要打开钱包     |
| [sendtoaddress](https://github.com/BhpAlpha/docs/blob/master/cli/1.2.0.8/api/sendtoaddress.md) | < asset_id > < address > < value > [fee=0]          | 向指定地址转账                                       | 需要打开钱包     |
...
| [sendtoaddressorder](https://github.com/BhpAlpha/docs/blob/master/cli/1.2.0.8/api/sendtoaddressorder.md) | < order >< asset_id > < address > < value > [fee=0] | 发送一个包含订单信息的交易                           | 需要打开钱包     |
