...
```c#
public static extern Bhp.SmartContract.Framework.Services.Bhp.Contract CreateContract(byte[] script, byte[] parameter_list, byte return_type, bool need_storage, string name, string version, string author, string email, string description)
```
